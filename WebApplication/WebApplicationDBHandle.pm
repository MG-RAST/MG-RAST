...
sub new {
    ...
    my $dbmaster;
    eval {
      $dbmaster = DBMaster->new(-database => $Global_Config::webapplication_db || "WebAppBackend",
				-host     => $Global_Config::webapplication_host || "localhost",
				-user     => $Global_Config::webapplication_user || "root",
				-password => $Global_Config::webapplication_password || "",
				-socket   => $Global_Config::webapplication_socket || "");
    };
