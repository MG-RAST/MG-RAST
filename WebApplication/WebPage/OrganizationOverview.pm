...
sub output {
  ...
  # load google api
  #$html .= '<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAkRz1gZ7fCa6Od2mN7oCZ-BSynG0dDULylNdNv9Nc574Gz8uDrBRHUhDOOMR0vZoPOcrFsl3goT422Q" type="text/javascript"></script>';
  #$html .= '<script src="http://maps.google.com/maps?file=api&amp;v=2&amp;key=ABQIAAAAkRz1gZ7fCa6Od2mN7oCZ-BSE2r1Y0DZTLT46K6etBFFRMlD2JRQ5nnlvY7gFPg_Dqf1RNidkwL4Kpg" type="text/javascript"></script>';
