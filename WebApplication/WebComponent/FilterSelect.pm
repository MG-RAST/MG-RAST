...
# $Id: FilterSelect.pm,v 1.14 2011-02-11 20:00:17 devoid Exp $
...
sub output {
  ...
  $select .= "<img src='$Global_Config::cgi_url/Html/clear.gif' onload='initialize_filter_select(\"" . $self->html_id() . "\");' />";
...
sub require_javascript {
  return ["$Global_Config::cgi_url/Html/FilterSelect.js"];
}
