...
#    }
	...
	# determine in which list box the attribute should be at
		...
		&& $user && ($user->has_right(undef, 'annotate', 'genome')) 
...
sub require_javascript {
    return ["$Global_Config::cgi_url/Html/DisplayListSelect.js", "$Global_Config::cgi_url/Html/PopupTooltip.js"];
}

sub require_css {
    return "$Global_Config::cgi_url/Html/DisplayListSelect.css";
}
