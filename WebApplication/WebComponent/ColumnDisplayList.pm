...
method of the table, as shown in the example below.
    ...
    my $retVal = CGI::img({ src => "$Global_Config::cgi_url/Html/clear.gif",
...
sub require_javascript {
    return ["$Global_Config::cgi_url/Html/ColumnDisplayList.js",
            "$Global_Config::cgi_url/Html/Ajax.js"];
}
...
=cut
sub require_css {
    return "$Global_Config::cgi_url/Html/ColumnDisplayList.css";
}
