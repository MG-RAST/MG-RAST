...
sub layout_questions {
  ...
  if ($layout eq "single-column") {
	...
	$help .= "&nbsp;&nbsp;<img src='$Global_Config::cgi_url/Html/wac_infobulb.png' onmouseover='hover(event, \"" . $qid . "\", \"" . $hover->id() . "\");'>";
      }
...
sub require_javascript {
  return ["$Global_Config::cgi_url/Html/datepickercontrol.js","$Global_Config::cgi_url/Html/FormWizard.js"];
}

sub require_css {
  return "$Global_Config::cgi_url/Html/datepickercontrol.css";
}
