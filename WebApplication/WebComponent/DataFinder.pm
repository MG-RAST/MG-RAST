...
sub output {
  ...
  my $crumbs = "";
  $content .= qq~<img src='$Global_Config::cgi_url/Html/clear.gif' onload='initialize_data_finder();'>~;
  
  return $content;
}

sub require_css {
  return "$Global_Config::cgi_url/Html/DataFinder.css";
}

sub require_javascript {
  return [ "$Global_Config::cgi_url/Html/DataFinder.js" ];
}
