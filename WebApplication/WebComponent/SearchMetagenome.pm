...
sub dbh {
  ...
  my $db = $self->job_db;
  my $host = $Global_Config::mgrast_metadata_host || "";
  my $user = $Global_Config::mgrast_metadata_user || "root";
  my $password = $Global_Config::mgrast_metadata_password || "";
...
sub dbh_data {
  ...
  my $db = $self->data_db || $Global_Config::mgrast_db ;
  my $host = $Global_Config::mgrast_dbhost || "";
  my $user = $Global_Config::mgrast_dbuser || "root";
  my $password = $Global_Config::mgrast_password || "";
