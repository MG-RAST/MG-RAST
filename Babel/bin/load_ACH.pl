...
my $file = "$Global_Config::data/ACHresolution/ACH_id_table";
...
if (-s "$Global_Config::data/ACHresolution/ACH_Sequence2MD5")
  {
    $dbf->load_table( tbl => "ACH_Sequence2MD5",file => "$Global_Config::data/ACHresolution/ACH_Sequence2MD5") ;
  }
