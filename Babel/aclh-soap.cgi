...
$Global_Config::clearinghouse_data, $Global_Config::clearinghouse_contrib set in the 
Global_Config.pm.
...
sub version {
    $Global_Config::clearinghouse_data =~ /.+\/(.+)$/;
    return ($1) ? $1 : $Global_Config::clearinghouse_data;
}
...
sub get_annotations {
    ...
    my $anno = new AnnoClearinghouse($Global_Config::clearinghouse_data,
				     $Global_Config::clearinghouse_contrib);
