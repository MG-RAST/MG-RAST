...
sub output {
  ...
  #my $cgi_url = "$Config::cgi_url/ajax.cgi";
  my $cgi_url;
  if ($Config::nmpdr_site_url or $Config::force_ajax_to_cgi_url) {
    $cgi_url = "$Config::cgi_url/ajax.cgi";
  } else {
...
sub require_javascript {
  return ["$Config::cgi_url/Html/Ajax.js"];
}
