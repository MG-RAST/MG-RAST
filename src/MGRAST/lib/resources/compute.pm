    ...
    my $content = { 'name' => $self->name,
		            ...
		            'requests' => [
				        ...
				        { 'name'        => "normalize",
				          ...
				          'method'      => "POST" ,
				          'type'        => "synchronous",
				          'attributes'  => { 'data' => ['list', ['list', ['float', 'normalized value']]],
				          ...
				          'parameters'  => { 'options'  => {},
							                 ...
							                 'body'     => { "auth" => ["string", "unique string of text generated by MG-RAST for your account"],
          							                         "data" => ["file", "file to run compute on"] } }
						},
						{ 'name'        => "heatmap",
						...
						{ 'name'        => "pcoa",
				          ...
				          'method'      => "POST" ,
				          'type'        => "synchronous",
				          'attributes'  => { 'data' => [ 'list', ['object', [{'id' => ['string', 'column id'],
                                                                              'pco' => ['list', ['float', 'principal component value']]}, "pcoa object"]] ],
