		  ...
		  'requests' => [ { 'name'        => "info",
				  ...
				  { 'name'        => "instance",
				    ...
				    'parameters'  => { 'options'     => { 'verbosity' => [ 'cv', [ [ 'minimal', 'returns only minimal information' ],
									  ...
									  'source' => [ 'cv', [ map { [ $_, "$_ data source" ] } @$sources ] ],
									},
...
sub attributes {
  return { "id"                  => [ 'string', 'unique object identifier' ],
	   ...
	   "rows"                => [ 'list object', 'list of row descriptions', { 'id' => [ 'string', 'unique identifier' ], 'metadata' => [ 'object', 'list of metadata objects', { 'taxonomy' => [ 'list string', 'list of the taxonomy levels' ], 'ontology' => [ 'list string', 'list of ontology levels' ], 'source id' => [ 'string', 'unique identifier for the selected source' ] } ] } ],
	   "columns"             => [ 'list object', 'list of column descriptions', { 'metadata' => [ 'hash', 'list of metadata, contains the metagenome' ] } ],
