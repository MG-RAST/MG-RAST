...
sub chart_export {
  ...
  my $file = $Config::temp."/".$cgi->param('file');
...
sub require_javascript {
  return [ "$Config::cgi_url/Html/MetagenomeOverview.js",
	   "$Config::cgi_url/Html/krona.js",
	   "$Config::cgi_url/Html/canvg.js",
	   "$Config::cgi_url/Html/rgbcolor.js",
