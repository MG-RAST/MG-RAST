...
sub new {
    ...
    my $dbmaster;
    eval {
      $dbmaster = DBMaster->new(-database => $Config::mgrast_metadata_db || "MGRASTMetadata",
				-host     => $Config::mgrast_metadata_host || "localhost",
				-user     => $Config::mgrast_metadata_user || "root",
