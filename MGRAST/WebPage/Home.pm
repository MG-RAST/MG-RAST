...
sub output {
 ...
 function bookmark(url, title) {
  ...
  my $bpcount = $formater->format_number(($self->app->data_handle('MGRAST')->Job->count_total_bp() / 1000000000), 0);
...
#  my $recentcount = $formater->format_number($self->app->data_handle('MGRAST')->Job->count_recent(30));
  ...
  $content .= "<div style='height:205px; background:white; width:650px; padding:10px;-webkit-border-radius-topright: 5px;-webkit-border-radius-bottomleft: 5px;-webkit-border-radius-bottomright: 5px;-moz-border-radius-bottomleft:5px;-moz-border-radius-bottomright:5px;-moz-border-radius-topright:5px; border-top-right-radius: 5px; border-bottom-right-radius: 5px; border-bottom-left-radius: 5px; color:#848484; font-size:14;'>";
  ...
  $content .= "<div class='clear'></div>";
  $content .= "<div style='background-color: #5281B0; border-radius: 5px; -webkit-border-radius: 5px; -moz-border-radius: 5px; color: white; padding: 6px 10px 10px 10px; float: left; width: 200px; height: 85px; margin-top: 10px;'>";
...
#  $content .= "<div class='sidebar_subitem' style='font-size: 12px; padding: 1 0;'># new submissions (30 days)<span class='sidebar_stat' style='padding-top:3px;'>".$recentcount ."</span></div>";
  $content .= "<div class='sidebar_subitem' style='font-size: 13px; padding: 1 0;'># base pairs<span class='sidebar_stat' style='font-size: 11px; padding-top:2px;'>".$bpcount." Gbp</span></div>";
