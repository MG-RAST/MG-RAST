...
sub output {
  ...
  $meta_text .= "<div style='padding:0 5px 5px 5px; text-align: justify;'><img src=\"$Global_Config::cgi_url/Html/metabolic.jpg\" style='width: 100; heigth: 100; float: left; padding: 5px 10px 10px 0;'><h3>Metabolic Profile with Subsystem</h3>";
  ...
  $phylo_text .= "<div style='padding:0 5px 5px 5px; text-align: justify;'><img src=\"$Global_Config::cgi_url/Html/phylogenetic.gif\" style='width: 100; heigth: 100;float: left; padding: 5px 10px 10px 0;'><h3>Phylogenetic Profile based on RDP</h3>";
...
<img src=\"$Global_Config::cgi_url/Html/clear.gif\" onload='parse_count_data();'>~;
