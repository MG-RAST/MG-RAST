...
sub output {
  ...
  my $graphicsDir = $Global_Config::temp_url . "/" ;
  my $jsDir       = $Global_Config::cgi_url . "/Html/" ;
  my $cssDir      =  $Global_Config::cgi_url . "/Html/" ;
...
~;
  ...
  if($pid){
    $download ="
<a href='ftp://ftp.metagenomics.anl.gov/metagenomes/$pid/$mid.raw.tar.gz'><img src='$Global_Config::cgi_url/Html/mg-download.png' alt='Download submitted metagenome' height='15'/><small>submitted</small></a>
<a href='ftp://ftp.metagenomics.anl.gov/metagenomes/$pid/$mid/metadata.xml'><img src='$Global_Config::cgi_url/Html/mg-download.png' alt='Download metadata for this metagenome' height='15'/><small>metadata</small></a>
<a href='ftp://ftp.metagenomics.anl.gov/metagenomes/$pid/$mid.processed.tar.gz'><img src='$Global_Config::cgi_url/Html/mg-download.png' alt='Download all derived data for this metagenome' height='15'/><small>analysis</small></a>" ;
  }
...
sub read_stats {
  ...
  if ((! -s $stats_file) && ($type =~ /^(protein|dna)$/i)) {
    system("$Global_Config::seq_length_stats --fasta_file $source_file --stat_file $stats_file $option");
  }
...
<td><a  onmouseover='hover(event,\"all_down\",".$down_info->id.")' href='ftp://ftp.metagenomics.anl.gov/projects/$id.raw.tar'><img src='$Global_Config::cgi_url/Html/mg-download.png' height='15'/><small>submitted metagenomes</small></a></td>
<td><a onmouseover='hover(event,\"meta_down\",".$down_info->id.")' href='ftp://ftp.metagenomics.anl.gov/metagenomes/$id/metadata.project-$id.xls'><img src='$Global_Config::cgi_url/Html/mg-download.png' height='15'/><small>metadata</small></a></td>
<td><a onmouseover='hover(event,\"derv_down\",".$down_info->id.")' href='ftp://ftp.metagenomics.anl.gov/projects/$id.processed.tar'><img src='$Global_Config::cgi_url/Html/mg-download.png' alt='Download all derived data for metagenomes of this project' height='15'/><small>analysis</small></a></td>
</tr></table>";
