...
sub init {
  ...
  my $config = $Global_Config::mgrast_formWizard_templates . "/FormWizard_$template.xml";
...
<table><tr>
  <td valign="center">
    ...
    <img id="expand_img" src="$Global_Config::cgi_url/Html/MGRAST-upload.png" width="50%"></a>
